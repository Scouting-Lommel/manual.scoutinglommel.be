...
automatisch om in een mooie pagina.
...
<figure>
  ...
  <figcaption>Een pagina bewerken: het blokken-gebied met de blokken van de pagina.</figcaption>
</figure>

Zo werkt het:

1. Open in het **Content Manager** de soort inhoud van de pagina die je wil bewerken
   (bv. "Pagina - Algemene informatie").
2. Klik op het item van de pagina (of op "Nieuw item" voor een nieuwe pagina).
3. In het blokken-gebied zie je de bestaande blokken. Met **"Een blok toevoegen"** voeg je
   een nieuw blok toe; met de pijltjes of door te slepen verander je de volgorde; met het
   prullenmandje verwijder je een blok.
4. Vul elk blok in en bewaar.
