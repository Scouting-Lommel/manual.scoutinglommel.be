...
1. **Heb je gepubliceerd?** Opslaan maakt alleen een concept; pas **Publiceren** maakt je wijziging live. Controleer de status bovenaan het item: die moet "Published" zijn (zie [04 · Een pagina bewerken](/04-pagina-bewerken/)).
2. **Herlaad de pagina.** Wijzigingen zijn live bij de volgende paginalading, maar je browser kan een oude versie tonen. Doe een **harde herlading**: op Mac **Cmd + Shift + R**, op Windows **Ctrl + Shift + R**. Of open de pagina in een privévenster.
...
1. **Controleer de Media Library.** Staat de afbeelding er nog? Als ze verwijderd is, verschijnt ze niet meer op de website.
2. **Voeg de afbeelding opnieuw toe.** Open de pagina in het CMS, ga naar het blok met de afbeelding en kies de afbeelding opnieuw uit de Media Library (of upload ze opnieuw). Zie [05 · Media](/05-media/).
3. **Publiceer** de pagina opnieuw en herlaad de website.

## Bezoekers zien een onderhoudspagina

De website staat in onderhoudsmodus. Dat gebeurt via de schakelaar **"Onderhoudspagina"** (_maintenanceMode_) in de instellingen (zie [08 · Instellingen](/08-instellingen/)).
