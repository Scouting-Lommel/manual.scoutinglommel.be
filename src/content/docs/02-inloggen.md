...
Open [admin.scoutinglommel.be](https://admin.scoutinglommel.be) in je browser en log in met
...
- **De "Leden"-lijst is zichtbaar, maar daar mag je niets wijzigen.** Daar staan
  persoonlijke gegevens van leden (e-mailadressen, telefoonnummers, adressen). Die worden
  **nooit** op de website getoond en je moet ze ook niet bewerken. Zie
